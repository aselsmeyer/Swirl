...
| Parts of this lesson will require the use of dplyr. If you don't have a basic knowledge of dplyr, you should exit this
| lesson and begin with the dplyr lessons from earlier in the course.
...
Error: unexpected symbol in "res <- gather(students2, sex_class, column count"
...
| Call gather() with the following arguments (in order): students2, sex_class, count, -grade). Store the result in a
| variable called res.
...
| arguments: data = res, col = sex_class, into = c("sex", "class"). You don't have to provide the argument names as long
...
#
students3 %>%
  gather(class, grade, class1 : class 5 , na.rm = TRUE) %>%
  print
...
Error in source(e$script_temp_path, encoding = "UTF-8") : 
  D:\users\f75562a\AppData\Local\Temp\RtmpQDCTsS/script2.R:22:39: unexpected numeric constant
21: students3 %>%
  22:   gather(class, grade, class1 : class 5
               ^
               ...
               | the script and type submit() at the prompt when you are ready, or type reset() to reset the script to its original
               | state.
...
# through class5 into a new variable called class.
               ...
               students3 %>%
                 ...
                 mutate(class, extract_numeric(class) %>%
                        ...
                        Error in source(e$script_temp_path, encoding = "UTF-8") : 
                          D:\users\f75562a\AppData\Local\Temp\Rtmp8s0UDv/script4.R:17:0: unexpected end of input
                        15:   mutate(class, extract_numeric(class) %>%
                                       16:   print
                                     ^
...
> submit()
                                     ...
                                     | Teachers decided to only take into consideration final exam grades in determining whether students passed or failed each class. As you
                                     | may have inferred from the data, students passed a class if they received a final exam grade of A or B and failed otherwise.
...
#
                                     ...
                                     sat %>%
                                       ...
                                       separate(part_sex, c("part", "sex") %>%
                                                ...
                                                Error in source(e$script_temp_path, encoding = "UTF-8") : 
                                                  D:\users\f75562a\AppData\Local\Temp\RtmpqosFlK/script8.R:22:0: unexpected end of input
